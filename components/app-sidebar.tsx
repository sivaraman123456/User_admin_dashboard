...
import {
  Sidebar, SidebarContent,SidebarGroup,  SidebarGroupLabel, SidebarMenu, SidebarMenuItem, SidebarMenuButton, SidebarHeader, SidebarRail,
...
const systemNav: NavItem[] = [{ title: "Settings", href: "/settings", icon: Settings }]
